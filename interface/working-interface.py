...
class Application(tk.Tk):
    ...
    def show_start_page(self):
        ...
        label = tk.Label(self.current_page, text="SignAlphabet", font=("Times New Roman", 48))
        label.grid()

        label = tk.Label(self.current_page, text="A Project by Group 8", font=("Times New Roman", 12))
        label.grid(pady=20)
    ...
    def show_alphabet_page(self):
        ...
        label = tk.Label(self.current_page, text="Pick a letter!", font=("Times New Roman", 16))
    ...
    def show_practice_page(self, selected_letter):
        ...
        label = tk.Label(self.current_page, text=label_text, font=("Times New Roman", 16))
        label.grid(row=0, column=0, columnspan=5, pady=(0, 10))

        go_back_button = tk.Button(self.current_page, text="Go Back", bg="lightgreen", command=self.show_alphabet_page)
        go_back_button.grid(row=1, column=0, columnspan=5, pady=(10, 0))
